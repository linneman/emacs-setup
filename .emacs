...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (queue sesman cider solarized-theme paredit org-tree-slide org-evil org-bullets multi-term free-keys evil-org evil-magit eimp dash-functional dash-at-point company)))
 '(tool-bar-mode nil))
(custom-set-faces
